...
import uat.utils.ScheduledUtils;
...
public class SeleniumBrowser {
    ...
    public void waitMs(int milliSeconds) {
        try {
            ...
            log.error("Exception on selenium waiting, " + rte);
        }
    }
    ...
    public String currentURL() {
        try {
            ...
            log.error("Timeout when trying to get currentUrl!");
            return null;
        } catch (WebDriverException wde) {
            log.error("Exception occured while trying to get currentUrl, " + wde);
            return null;
        }
    }
